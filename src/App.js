...
function App() {
  ...
  const getDetails = async () => {
    console.log(
      "transaction of which to retrieve details:",
      storeHashTransaction
    );
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <h1 className="h1">Ethereum and Private IPFS Network</h1>
        <span style={{ color: "#980000", fontSize: "0.7em" }}>
          <i>adapted from create-react-app</i>
        </span>
      </header>
      <hr />
      ...
      <Button variant="outline-primary" size="lg" onClick={getDetails}>
        {" "}
        3.Get Storage Transaction Details{" "}
      </Button>
      <hr />
